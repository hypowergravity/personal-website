...
![Having Tom (the drug molecule) navigate a maze to find Jerry (the protein):
	...
	•	Allosteric vs. orthosteric binding (different exits or hidden chambers).](../../image/chasing_drug_title.png){ width=60% }
...
![Tom entering a maze, chasing Jerry’s scent → diffusion and initial binding.](../../image/chasing_the_drug_chapter1.png){ width=50% }
...
![The maze branching into many rooms with “fake Jerrys” → cross-reactivity.](../../image/chasing_the_drug_chapter2.png){ width=50% }
...
![Multiple near-identical mazes stacked → GPCR/kinase families and conserved pockets.](../../image/chasing_the_drug_chapter3.png){ width=50% }
...
![Tom consulting a holographic AI map of the maze → computational prediction.](../../image/chasing_the_drug_chapter4.png){ width=50% }
...
![ Tom discovering Jerrys in other mazes → phenotypic screening and repurposing.](../../image/chasing_the_drug_chapter5.png){ width=50% }
...
**Insight**: We already know the molecule's systemic effects; we just find new contexts where they're beneficial.

---

## Chapter 6: Crystallography and the Future — When Tom Uses X-Rays

![Tom using an X-ray torch to view hidden tunnels → crystallographic fragment screening.](../../image/chasing_the_drug_chapter6.png){ width=50% }
