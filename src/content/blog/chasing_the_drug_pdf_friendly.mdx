...
![Having Tom (the drug molecule) navigate a maze to find Jerry (the protein):
	...
	•	Allosteric vs. orthosteric binding (different exits or hidden chambers).](./chasing_drug_title.png){ width=60% }
...
![Tom entering a maze, chasing Jerry’s scent → diffusion and initial binding.](./chasing_the_drug_chapter1.png){ width=50% }
...
![The maze branching into many rooms with “fake Jerrys” → cross-reactivity.](./chasing_the_drug_chapter2.png){ width=50% }
...
![Multiple near-identical mazes stacked → GPCR/kinase families and conserved pockets.](./chasing_the_drug_chapter3.png){ width=50% }
...
![Tom consulting a holographic AI map of the maze → computational prediction.](./chasing_the_drug_chapter4.png){ width=50% }
...
![ Tom discovering Jerrys in other mazes → phenotypic screening and repurposing.](./chasing_the_drug_chapter5.png){ width=50% }
...
![Tom using an X-ray torch to view hidden tunnels → crystallographic fragment screening.](./chasing_the_drug_chapter6.png){ width=50% }
